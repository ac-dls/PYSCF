...
ao_file = "/scratch/dnlrea/pedro.romano/ao_vals_memmap_chiral.npy"  # <- corrected: values, not grads 
ao_grads_file = "/scratch/dnlrea/pedro.romano/ao_grads_memmap_chiral.npy"
ao_grads_memmap = np.lib.format.open_memmap(ao_grads_file, mode='r')
fft_file = "/scratch/dnlrea/pedro.romano/fft_kernel_data_chiral.npz"
ao_meta = np.load("/scratch/dnlrea/pedro.romano/ao_metadata_chiral.npz")
grid_coords_file = "/scratch/dnlrea/pedro.romano/grid_coords_chiral.npz"
...
scf_chk_tpl     = "/scratch/dnlrea/pedro.romano/results_S3_CNT75/scf_field_{E}.chk"
mo_info_tpl     = "/scratch/dnlrea/pedro.romano/results_S3_CNT75/MO_info_field{E}.txt"
vacuum_tpl      = "/scratch/dnlrea/pedro.romano/results_S3_CNT75/vacuum_profile_field{E}.txt"
ip_tpl          = "/scratch/dnlrea/pedro.romano/results_S3_CNT75/IP_field{E}.txt"
wf_tpl          = "/scratch/dnlrea/pedro.romano/results_S3_CNT75/work_function_field{E}.txt"
